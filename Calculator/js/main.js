...
const Calculator = {
    ...
    First_Operand: null,
    //Checks if the second operand has been inputted
...
//Updates the calculator screen with teh contents of Display_Value
function Update_Display() {
    //Makes use o fthe calculator-screen class to target the 
